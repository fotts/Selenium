...
//public class TestNG_DataProvider extends ExtReports {
public class TestNG_DataProvider {	

	@DataProvider
	public Object[][] testdata_shoppingCart() {
		return new Object[][] { 
			    new Object[] { "IE", "IPhone", "2", "Adam", "MIAMI BEACH", "FL" },
				new Object[] { "FF", "TV", "3", "Brett", "MANHATTAN", "NY" },
				new Object[] { "CH", "Canon", "4", "Christene", "ALPHARETTA", "GA" },
				new Object[] { "IE", "Echo", "5", "David", "BOSTON", "MA" } 
			    };
	}

	@Test(dataProvider = "testdata_shoppingCart")
	public void tc_shoppingCartTesting(String runTestInBrowser, String item2Search, String qty, String customerName, String customerCity,
...
//		extentTest.log(LogStatus.INFO, "Searching Item: " +item2Search);
		...
		ReUsableFunctions.TakeSceenshot(customerName);
